...
- [schemas](#schemas)
  ...
  - [NonZeroInt64Schema](#nonzeroint64schema)
...
```ts
export declare const make: (i: bigint, overrideOptions?: ParseOptions) => bigint
```
...
```ts
export declare const NonZeroInt64Schema: Schema.Union<
