 ...
 * @category decoding
 */
export const fromHex = Function.makeDecodeSync(FromHex, Bytes128Error, "Bytes128.fromHex")
 ...
 * @category encoding
 */
export const toHex = Function.makeEncodeSync(FromHex, Bytes128Error, "Bytes128.toHex128")
 ...
 * @category decoding
 */
export const fromVariableHex = Function.makeDecodeSync(
  VariableBytesFromHex,
  Bytes128Error,
  "Bytes128.fromVariableHex128"
)
 ...
 * @category encoding
 */
export const toVariableHex = Function.makeEncodeSync(VariableBytesFromHex, Bytes128Error, "Bytes128.toVariableHex128")
...
export namespace Either {
   ...
   * @category decoding
   */
  export const fromHex = Function.makeDecodeEither(FromHex, Bytes128Error)
  /**
   * Safely encode fixed-length bytes to hex.
   * @since 2.0.0
   * @category encoding
   */
  export const toHex = Function.makeEncodeEither(FromHex, Bytes128Error)
  /**
   * Safely decode variable-length hex (0..BYTES_LENGTH) into bytes.
   * @since 2.0.0
   * @category decoding
   */
  export const fromVariableHex = Function.makeDecodeEither(VariableBytesFromHex, Bytes128Error)
  /**
   * Safely encode variable-length bytes (0..BYTES_LENGTH) to hex.
   * @since 2.0.0
   * @category encoding
   */
  export const toVariableHex = Function.makeDecodeEither(VariableBytesFromHex, Bytes128Error)
}
