 ...
 * @category schemas
 */
export const FromCDDL = Schema.transform(CDDLSchema, PlutusV3, {
  strict: true,
  encode: (toI) => toI.script,
  decode: (fromA) => new PlutusV3({ script: fromA })
})
 ...
 * @category equality
 */
export const equals = (a: PlutusV3, b: PlutusV3): boolean => eqBytes(a.script, b.script)
