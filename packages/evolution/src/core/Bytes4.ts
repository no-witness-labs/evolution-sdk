 ...
 * @category decoding
 */
export const fromHex = Function.makeDecodeSync(BytesFromHex, Bytes4Error, "Bytes4.fromHex")
 ...
 * @category encoding
 */
export const toHex = Function.makeEncodeSync(BytesFromHex, Bytes4Error, "Bytes4.toHex4")
...
export namespace Either {
   ...
   * @category decoding
   */
  export const fromHex = Function.makeDecodeEither(BytesFromHex, Bytes4Error)
  /**
   ...
   * @category encoding
   */
  export const toVariableHex = Function.makeEncodeEither(VariableBytesFromHex, Bytes4Error)
}
